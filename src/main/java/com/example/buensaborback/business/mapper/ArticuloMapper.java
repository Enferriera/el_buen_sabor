...
@Mapper(componentModel = "spring", uses = {ImagenArticuloMapper.class, CategoriaService.class, CategoriaMapper.class,UsuarioMapper.class, UnidadMedidaService.class})
